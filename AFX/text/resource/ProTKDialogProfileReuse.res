(Dialog ProTKDialogProfileReuse
    (Components
...
(Layout LaySelectType
    ...
    (Resources
        (lbHeaderSelectType.Label       "Profile to Reuse")
...
(Layout LayInstanceTypeCb
    ...
    (Resources
        ...
        (cbReuse.HelpText               "Reassemble existing profile instance.")
        ...
        (cbCopy.HelpText                "Assemble copy of profile.")
        ...
        (cbCopySec.HelpText             "Assemble profile by copying section of existing profile.")
