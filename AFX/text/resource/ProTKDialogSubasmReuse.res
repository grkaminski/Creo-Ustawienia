...
(Layout LaySelectType
    ...
    (Resources
        (lbHeaderSelectType.Label       "Subassembly to Reuse")
...
(Layout LayInstanceTypeComponent
    ...
    (Resources
        ...
        (cbReuse.HelpText               "Reassemble existing subassembly instance.")
        ...
        (cbCopy.HelpText                "Assemble copy of subassembly.")
